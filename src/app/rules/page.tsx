  ...
  return (
    <PageWrapper className="bg-gray-100">
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="grid gap-8 lg:grid-cols-2">
          <Card className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {courses.map((course) => (
                <div key={course.id} className="p-4 bg-gray-50 shadow-md rounded-lg flex flex-col justify-between">
                  <h3 className="text-xl font-semibold text-gray-800">{course.name}</h3>
                  {course.note && <p className="text-gray-500 text-sm mt-1">*{course.note}</p>}
                </div>
              ))}
            </div>
          </Card>
        ...
        <Card className="p-8 bg-white rounded-lg shadow-lg max-w-6xl mx-auto mt-8 text-balance">
